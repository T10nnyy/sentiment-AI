      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Advanced AI-powered sentiment analysis with real-time processing, batch operations, and comprehensive
            analytics
          </p>
          ...
          <TabsContent value="analyze" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Analyze the sentiment of any text using our advanced AI models</CardDescription>
              </CardHeader>
              <CardContent>
                <SentimentAnalyzer />
              </CardContent>
